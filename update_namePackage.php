...
if (!$_SESSION['id']) {
    ...
    $query = "SELECT name_package.id_package,name_service.id_service, name_service.name_ser,name_package.name_pack,name_package.type_package
    FROM name_package 
            ...
            <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary cfdeleteupdatepackage">ลบ</button>
                    </div>
                </div>
            </div>
        </div>
